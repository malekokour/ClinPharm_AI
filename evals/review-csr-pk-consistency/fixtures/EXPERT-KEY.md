...
- Every output field of the register is exercised — a fixture that never produces
  ...
  behaviours.
- Severity is deliberately weighted toward Critical (**5 of 12**), because the
...
- The detection-path split is an engineering allocation, not a hope: **6 script**,
  **3 script+model**, **3 model-only**. Per-path recall is reported separately;
...
Critical 5 · Major 3 · Minor 1 → maximum weighted score **5(5) + 4(3) + 3(1) = 40**
