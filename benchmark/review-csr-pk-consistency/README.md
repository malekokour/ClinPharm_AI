...
Catalog `evidence_level` reads `synthetic-benchmark-pending-run` for exactly this
reason — the fixture existing is not the same as the benchmark having been run.
