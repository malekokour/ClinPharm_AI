...
**At version 0.1.0 no planted-defect fixture has been evaluated for this skill.**
The library's rule is that an interaction module promotes only with its own
fixture; this skill inherits that debt and states it rather than hiding it. Treat
