#!/usr/bin/env python3
"""VENDORED at build time from shared/tools/ — do not edit here.
...
def check_unit(parameter: str, unit: str, locator: str, report: Report,
    ...
    ``declared_units`` maps a parameter to the unit the analysis plan specifies,
    e.g. ``{"cl": "L/h"}``. Checking only against the class vocabulary misses the
