...
Run the permitted-source preflight at `shared/contracts/source-preflight.md`
...
Confirm the accountable owner per `shared/contracts/human-review.md`. Ownership
...
`shared/tools/cross_document_consistency.py`, vendored into the package at build
...
checks at `shared/tools/pk_plausibility.py` provide unit consistency and
...
detailed at `shared/contracts/human-review.md`.
