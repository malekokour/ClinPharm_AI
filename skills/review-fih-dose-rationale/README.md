...
**Ordinary chat** — attach the starter document for this skill together with the
section under review, and follow the workflow it carries. The starter lives under
`starter/review-fih-dose-rationale/` — **not yet present**, because this package
is `built` rather than `released`. The starter ships with the evaluation, in Markdown
and DOCX, because some hosts reject one and accept the other.
...
Licence MIT · version 0.1.0 · research id S02 · collection
[clinical-pharmacology](../../collections/clinical-pharmacology/)
