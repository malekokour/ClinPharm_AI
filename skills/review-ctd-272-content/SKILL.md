...
Run `scripts/reconcile.py`, which vendors T05 `cross_document_consistency` in its
document-scoped review mode — **not** the programme-thread mode used by
