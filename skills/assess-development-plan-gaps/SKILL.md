...
`qt-assessment` · `immunogenicity-ada` · `biologics-mab-pk` ·
`pediatric-pk-extrapolation` · `oncology-dose-optimization` ·
`combination-regimen-pk`

They live at `shared/modules/` in the repository and are vendored into the
