...
`shared/contracts/evidence-hierarchy.md`.
...
Where a unit maps to a topic covered by a module under `shared/modules/`, name
...
Apply the precedence in `shared/contracts/evidence-hierarchy.md`. Where two
sources disagree, preserve **both statements with both locators** and mark the
unit `conflicting`, per `shared/contracts/contradiction-ledger.md`. Never
...
separate named acts, detailed in `shared/contracts/human-review.md`.
