...
ClinPharm AI is designed to precede task-specific skills.

## Pattern

```text
ClinPharm AI context builder
    → AI Working Pack
        → task-specific skill
...
ClinPharm AI does not vendor, fork, or imply affiliation with that project.
